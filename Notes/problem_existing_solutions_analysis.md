...
adaptive Top-K, and learned fusion weights
        ↓
These approaches involve static tuning, raw-score transformation,
post-ranking context selection, or additional model/data requirements
        ↓
Research question:
...
**Important distinction:** This note does not establish VA-RRF as novel. It documents the problem and existing solution space that must be considered before evaluating the proposed method.
